...
var
  ...
  begin
    ...
    if (pos('Akaviri Katana', itemName) > 0) OR (pos('Blades Sword', itemName) > 0) then begin
      mess('changing' + itemName);
      seev(rec, 'DNAM\Speed', '1.125');
      seev(rec, 'DNAM\Reach', '1.0');
    ...
    if (pos('Tanto', itemName) > 0) OR (pos('Blades Dagger', itemName) > 0)then begin
      mess('changing' + itemName);
      seev(rec, 'DNAM\Speed', '1.35');
      seev(rec, 'DNAM\Reach', '0.65');
      seev(rec, 'DNAM\Stagger', '0.0');
      seevi(rec, 'DATA\Damage', 4 + GetDamageOffset(rec));
      seevi(rec, 'CRDT\Damage', geevi(rec,'DATA\Damage') div 2);
    end;
    ...
    if (pos('Akaviri Shortspear', itemName) > 0) OR (pos('Blades Shortspear', itemName) > 0) then begin
      mess('changing' + itemName);
      seev(rec, 'DNAM\Speed', '1.1');
      seev(rec, 'DNAM\Reach', '1.2');
      seev(rec, 'DNAM\Stagger', '0.15');
      seevi(rec, 'DATA\Damage', 7 + GetDamageOffset(rec));
      seevi(rec, 'CRDT\Damage', geevi(rec,'DATA\Damage') div 2);
    end;
